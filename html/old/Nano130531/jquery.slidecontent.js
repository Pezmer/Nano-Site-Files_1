(function($){
    ...
    $.PP.SlideContent.defaultOptions = {
        ...
        ajaxContent  : ['#sidebar-nav','#content','.equipmentinfo']   // Array of additionnal replace content (with ajax)
        linkAllow    : ['#sidebar a','#menu a.nav','.equipmentinfo a']    // Link with action of slideContent (default: 'a')  | Array of JQuery Selector ['selectorA','selectorB','selectorC']
